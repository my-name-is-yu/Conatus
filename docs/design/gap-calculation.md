...
The risk of treating something poorly understood as "no problem" is high. Especially for long-term goals, overlooked issues can become costly later. Moxen should be designed to "fear what it cannot see."
...
- Improvements in small child goals are less likely to be reflected in the parent score, which can reduce moxention
