...
How far can Moxen act autonomously? This is not a question of "what it can do" but of "what it is permitted to do."
...
Moxen's degree of autonomy is determined by two independent axes.
...
This prevents Moxen from acting boldly in a low-confidence state. Execution based on "I don't really know but it's probably fine" is not permitted.

### Axis 2: Trust Balance

**How much user trust has Moxen accumulated through its track record so far?**
...
The combination of confidence and trust balance determines Moxen's behavioral mode.
...
The current position is accurately known. However, Moxen itself has no track record yet. In the early stages, it operates in "propose and get approval before acting" mode, accumulating a track record.
...
User overrides are explicitly logged. It should be traceable "why Moxen is acting differently from its own judgment."
...
**What does "trusting" mean?**: For a user to trust Moxen means not "believing Moxen's judgment is correct," but "choosing to pay the cost of verifying Moxen's judgment after the fact." Even in autonomous execution mode, users can always check the action log. Trust is supported by transparency.
...
**Non-manipulability of confidence**: Confidence is not something Moxen sets subjectively. It is determined objectively by the observation method. This prevents Moxen from self-declaring "my judgment is certain" to increase its own autonomy. The only way to increase confidence is to use a more reliable observation method.
