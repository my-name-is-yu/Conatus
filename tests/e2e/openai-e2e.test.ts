...
describe.skipIf(!API_KEY_SET)("OpenAI E2E — real API calls", () => {
  ...
  it(
    "buildLLMClient() with MOXEN_LLM_PROVIDER=openai creates an OpenAILLMClient",
    async () => {
      const originalProvider = process.env["MOXEN_LLM_PROVIDER"];
      process.env["MOXEN_LLM_PROVIDER"] = "openai";
      ...
      try {
        ...
        if (originalProvider === undefined) {
          ...
          process.env["MOXEN_LLM_PROVIDER"] = originalProvider;
        }
      }
    },
    30_000
