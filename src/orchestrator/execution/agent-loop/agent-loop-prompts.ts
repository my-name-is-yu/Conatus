...
export function buildAgentLoopBaseInstructions(options?: {
  ...
  const rules = [
    ...
    "Do not use shell or shell_command for file edits, heredocs, here-strings, inline Python/Node/Ruby/Perl rewrites, or other multiline shell write patterns; use apply_patch or another typed file edit tool instead.",
