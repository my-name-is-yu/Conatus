...
vi.mock("../durable-loop/preparation.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../durable-loop/preparation.js")>();
  return {
    ...actual,
...
import { runTaskCycleWithContext } from "../durable-loop/task-cycle.js";
import { verifyWithTools } from "../verification-layer1.js";
import { buildLoopToolContext } from "../durable-loop/preparation.js";
