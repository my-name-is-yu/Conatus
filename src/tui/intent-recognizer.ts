...
const SYSTEM_PROMPT = `You are Moxen's assistant. Moxen is an AI agent orchestrator that manages goals with measurable dimensions.
...
For any other input, respond conversationally. Explain Moxen's state, answer questions, or suggest what to do.
