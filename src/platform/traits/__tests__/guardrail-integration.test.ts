...
function createMockAdapter(
  result: Partial<import("../../execution/task/task-lifecycle.js").AgentResult> = {}
): import("../../execution/task/task-lifecycle.js").IAdapter {
  return {
    adapterType: "mock",
    async execute(
      _task: import("../../execution/task/task-lifecycle.js").AgentTask
    ): Promise<import("../../execution/task/task-lifecycle.js").AgentResult> {
      return {
        success: true,
...
describe("TaskLifecycle guardrail integration", () => {
  ...
  function createLifecycle(
    ...
    return new TaskLifecycle(
      ...
      strategyManager,
      stallDetector,
      { guardrailRunner, execFileSyncFn: makeMockExecFileSync() }
    );
  }
