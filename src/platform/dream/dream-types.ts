...
export const DreamLogConfigSchema = z.object({
  ...
  activation: z.object({
    ...
    autoAcquireKnowledge: z.boolean().default(true),
    learnedPatternHints: z.boolean().default(true),
    playbookHints: z.boolean().default(true),
    workflowHints: z.boolean().default(true),
    strategyTemplates: z.boolean().default(true),
    decisionHeuristics: z.boolean().default(true),
    graphTraversal: z.boolean().default(true),
  }).default({}),
